...
\include{sections/00_Einleitung}
\setcounter{page}{1}
\tableofcontents
\newpage
\input{sections/01_ersteVorlesung}
\input{sections/02_zweiteVorlesung}
\input{sections/03_dritteVorlesung}
\input{sections/04_vierteVorlesung}
\input{sections/05_fuenfteVorlesung}
%%---BIBLIOGRAPHY------------------------------------------------------------------------
{\sloppypar
